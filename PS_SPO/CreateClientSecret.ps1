...
The new Secret will get saved in Secret_New.txt at same location from where you run this powershell. Save this clientsecret, 
along with clientid or appid. This will be needed in web.config of your PHA and for future references. 
...
Run the script. It will prompt for your onmicrosoft account and password. Once authentication succeeds you will see Secret_New.txt at
same location from where the script was ran. 
#> 
